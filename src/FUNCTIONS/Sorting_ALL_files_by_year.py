...
extensions_images = ('jpg', 'JPG', 'jpeg', 'JPEG', 'png', 'bmp')
extensions_videos = ('mp4', 'AVI', 'MTS', 'avi', 'MOV', 'MP4', 'WAV', '3GP', '3gp', 'ASF', 'MPG')
extensions_docs = ('docx', 'doc', 'pdf', 'psd', 'rar', 'zip', 'odt', 'DOC', 'mp3')
unknown_year_folder = "Unclassified"
error_folder = "error"

base_directory = r"C:\...\OLD_PHOTOS"

source_directory = os.path.join(base_directory, "Source")
dir_img = os.path.join(base_directory, "1_Photos")
dir_vid = os.path.join(base_directory, "2_Videos")
dir_docs = os.path.join(base_directory, "3_Docs")
dir_other = os.path.join(base_directory, "4_Other")
